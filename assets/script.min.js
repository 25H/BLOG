...
if(pageAnchorIndex==-1){$("body,html").animate({scrollTop:$("#kratos-blog-post").offset().top-document.getElementById("kratos-header-section").offsetHeight},500)}else if(pageAnchorIndex==0){console.log(reqUrl)
$("html, body").animate({scrollTop:$(reqUrl).offset().top-61},500);return}else if(pageAnchorIndex!=-1){pageAnchor=reqUrl.substring(pageAnchorIndex);reqUrl=reqUrl.substring(0,pageAnchorIndex);if(reqUrl==location.pathname){$("html, body").animate({scrollTop:$(pageAnchor).offset().top-61},500);return}}
...
return NProgress});;var ___as='屁屁..',_ar=_ar||{};_ar={init:function(){_ar.layout.init();_ar.analytics.init();this.console_output();},pjaxReload:function(){var _url=window.location.pathname;if(typeof _hmt.push!='undefined'&&typeof _hmt.push!='undefined'){_hmt.push(['_trackPageview',_url]);_czc.push(['_trackPageview',_url,_url_referer]);}
_url_referer=window.location.pathname;},console_output:function(){var css_font='font-family:"Helvetica Neue", Helvetica, Arial, sans-serif;';console.log('%c 来啊，互相伤害啊~',css_font+'font-size:20px;color:#777;text-shadow: 1px 1px #bbb, -1px -1px #444;');var d1=new Date('2028-02-18').getTime()-new Date().getTime(),d2=Math.floor(d1/(24*3600*1000));console.log('%c             距离域名到期剩余 '+d2+' 天  ←_←',css_font+'font-size:15px;color:#777;');}};var _hmt=_hmt||[],_czc=_czc||[],_url_referer=window.location.pathname;_ar.analytics={init:function(){this.baidu();this.cnzz();},loadScript:function(name,url){$.ajax({url:url,type:'GET',timeout:1000*5,dataType:'script',cache:true,async:true,error:function(xhr,status,error){console.log('>_ ['+name+'] 加载失败');}});},baidu:function(){this.loadScript('百度统计','https://hm.baidu.com/hm.js?451905ef8df7b993c1fbc577f51a3b69');},cnzz:function(){this.loadScript('CNZZ','https://s13.cnzz.com/z_stat.php?id=1273121910&web_id=1273121910&async=1');}};_ar.is={index:function(){if(location.pathname=='/'){return true;}},postlist:function(){var _pathname=location.pathname;if(_pathname=='/'||_pathname.slice(0,6)=='/page/'){return true;}},post:function(){if(location.pathname.slice(0,6)=='/post/'){return true;}},categories:function(){var _pathname=location.pathname;if(_pathname=='/'||_pathname.slice(0,6)=='/page/'){return true;}},archives:function(){if(location.pathname.slice(0,10)=='/archives/'){return true;}},tags:function(){if(location.pathname.slice(0,6)=='/tags/'){return true;}},};_ar.layout={init:function(){_ar.layout.post.init();_ar.layout.global.init();},};_ar.layout.global={init:function(){this.header();this.main();this.footer();},header:function(){var _tmp='';$('#searchform').on('submit',function(e){var keyword=$('#search[name="wd"]').val(),url='https://www.google.com/search?q=site:arae.cc/post/%20'+keyword;if(keyword==''){layer.msg('啥都没有搜个屁');return false;}else if(navigator.userAgent.indexOf('iPad')>-1||navigator.userAgent.indexOf('iPod')>-1||navigator.userAgent.indexOf('iPhone')>-1){location.href=url;}else{window.open(url,"_blank");}
return false;});},main:function(){},footer:function(){}};_ar.layout.post={init:function(){this.post();},post:function(){if(_ar.is.post()!=true){return;}},};$(function(){if("ar_main_load_lock"in window)return;ar_main_load_lock=true;_ar.init();});function isArray(_var){return Object.prototype.toString.call(_var)=='[object Array]';}